function [Delta_opt,Sigma_opt,P_opt,ll_rec]=EM1_ref(X,DF,Delta_ini,Sigma_ini, P_ini)
...
%                 EM algorithm. The diagonal values are estimated from data
%
...
% Updated 2014.11.3: relax the diagonal values of Delta from 1/(df-1) to
% being estimated from data
